...
exports.ForgotPassword= async (req, res) => {
    const company = Company.findOne(req.body.email);
    ...
    const option = {name: company.companyName, linkReset: `${process.env.URL_Front}reset-password${token.token}`, linkForgot: `${process.env.URL_Front}forgot-password` }
